    ...
    <Swiper spaceBetween={30}
      ...
      <SwiperSlide>
        <div className="sw swiper_main_1">
          ...
          <Typography variant="h6" style={{ fontFamily: 'Open Sans', margin:'2.5rem' ,textAlign: 'justify'}}>is the medical specialty that focuses on
      ...
      <SwiperSlide>
        ...
        <Typography variant="h3" style={{ fontFamily: 'Open Sans' }}> Pediatrics</Typography>
          <Typography variant="h6" style={{ fontFamily: 'Open Sans', margin:'2.5rem',textAlign: 'justify' }}>is dedicated to caring for the youngest patients. 
      ...
      <SwiperSlide>
        ...
        <Typography variant="h3" style={{ fontFamily: 'Open Sans' }}> Internal Medicine</Typography>
          <Typography variant="h6" style={{ fontFamily: 'Open Sans' , margin:'2.5rem',textAlign: 'justify'}}>also known as clinical medicine, forms
